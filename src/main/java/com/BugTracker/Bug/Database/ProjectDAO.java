...
public class ProjectDAO {
    ...
    public Project findById(Integer id) {
        return jdbcTemplate.query("select * from Projects where idProject = " + id, new ProjectRowMapper()).get(0);
    }

    public void saveProject(String name, String description, int code) {
        jdbcTemplate.update("insert into Projects (idProject, Code, Name, AssignedTo, Description) values (null, ?, ?, ?, ?)",
